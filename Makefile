...
40image-6: 40image.o compress40.o read_PPM.o read_write_BCI.o \
	data_conversion.o bitpack.o uarray2.o a2plain.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

clean: 
	rm -f 40image compress40 read_PPM read_write_BCI data_conversion \
	bitpack uarray2 uarray2b a2plain *.o
